...
struct usb_descriptor_header *diag_hs_descriptors[6];
struct usb_descriptor_header *diag_fs_descriptors[6];
...
static int __init diag_init(void)
{
	...
	diag_hs_descriptors[1] = (struct usb_descriptor_header *)&header_desc;
	diag_hs_descriptors[2] = (struct usb_descriptor_header *)&mdlm_desc;
	diag_hs_descriptors[3] =
		(struct usb_descriptor_header *)&hs_bulk_in_desc;
	diag_hs_descriptors[4] =
		(struct usb_descriptor_header *)&hs_bulk_out_desc;
	diag_hs_descriptors[5] = NULL;

	diag_fs_descriptors[0] = (struct usb_descriptor_header *)&intf_desc;
	diag_fs_descriptors[1] = (struct usb_descriptor_header *)&header_desc;
	diag_fs_descriptors[2] = (struct usb_descriptor_header *)&mdlm_desc;
	diag_fs_descriptors[3] =
		(struct usb_descriptor_header *)&fs_bulk_in_desc;
	diag_fs_descriptors[4] =
		(struct usb_descriptor_header *)&fs_bulk_out_desc;
	diag_fs_descriptors[5] = NULL;
